...
req = requests.get("http://ncov.mohw.go.kr/supportPolicyBoardList.do?brdId=5&brdGubun=52")
html = req.text
...
for v in urllist:
    if v not in new_list:
        new_list.append("http://ncov.mohw.go.kr/shBoardView.do?brdId=5&brdGubun=52&ncvContSeq=" + v)
...
data.to_csv('weak.csv', encoding= 'UTF-8')
print("Complete!")