...
req = requests.get("http://ncov.mohw.go.kr/tcmBoardList.do?brdId=&brdGubun=&dataGubun=&ncvContSeq=&contSeq=&board_id=145&gubun=")
html = req.text
...
for k in range(len(urllist)):
    ...
    +str(urllist[k][3])+'&gubun=BDH').replace("'",""))
...
data.to_csv('newsex.csv', encoding= 'UTF-8')
print("Complete!")
